        ...
        for i in urls_and_titles:
            ...
            if(i not in url_wiki):
                if i is not None and "/wiki" in i: 
                    if i.startswith("https://americanfootball.fandom.com"): 
                        NLinks += 1

                        linha_csv.append([i])
                        wiki_url.append(i)
                    else: 
                        i = 'https://americanfootball.fandom.com' + i # adiciona o prefixo da URL 
                        NLinks+=1
                ...
                i = 'https://americanfootball.fandom.com' + i
                NLinks+=1
...
Request('https://americanfootball.fandom.com/wiki/Special:AllPages', wiki_url)
